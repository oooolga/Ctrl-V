...
BBOX_MODEL_DIR="/network/scratch/x/xuolga/Results/sd3d/bdd100k_segmentation_predict_240515_102502_bk"

PROJECT_NAME="ctrl_v"

accelerate launch --config_file config/a100l.yaml tools/draw_teaser.py \
